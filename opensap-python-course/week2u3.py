...
The list should be named sell_list. The list should only contain the stock symbol, not the price or the absolute change. Print the resulting list."""
...
for stock in stocks:
    if (stock[1] * 0.05) < stock[2]:
        sell_list.append(stock[0])

print("sell list is", sell_list)  